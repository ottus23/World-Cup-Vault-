...
export const tournaments: Tournament[] = [
  { year: 1930, host: 'Uruguay', champion: 'Uruguay', runnerUp: 'Argentina', historicMoment: 'The First Final', keyPlayer: 'Guillermo Stábile', finalScore: '4-2', story: 'The inaugural FIFA World Cup saw the hosts emerge victorious in front of 93,000 spectators.', image: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Uruguay_1930_world_cup_champion.jpg' },
  { year: 1934, host: 'Italy', champion: 'Italy', runnerUp: 'Czechoslovakia', historicMoment: 'Pozzo’s Masterclass', keyPlayer: 'Giuseppe Meazza', finalScore: '2-1 (aet)', story: 'Vittorio Pozzo guided Italy to their first title in a physically demanding tournament on home soil.', image: 'https://upload.wikimedia.org/wikipedia/commons/3/30/Italy_1934_champion.jpg' },
  { year: 1938, host: 'France', champion: 'Italy', runnerUp: 'Hungary', historicMoment: 'Back-to-Back Glory', keyPlayer: 'Leônidas', finalScore: '4-2', story: 'Italy became the first nation to successfully defend their title under the shadow of looming global conflict.', image: 'https://upload.wikimedia.org/wikipedia/commons/1/14/Italy_1938_champion.jpg' },
  { year: 1950, host: 'Brazil', champion: 'Uruguay', runnerUp: 'Brazil', historicMoment: 'The Maracanazo', keyPlayer: 'Obdulio Varela', finalScore: '2-1', story: 'In the most shocking upset in football history, Uruguay silenced a record crowd of 199,854 at the Maracanã.', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Obdulio_Varela_1950.jpg' },
  { year: 1954, host: 'Switzerland', champion: 'West Germany', runnerUp: 'Hungary', historicMoment: 'The Miracle of Bern', keyPlayer: 'Ferenc Puskás', finalScore: '3-2', story: 'West Germany achieved the impossible, coming back against the heavily favored Mighty Magyars in driving rain.', image: 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Deutschland_Kader_1954.jpg' },
  { year: 1958, host: 'Sweden', champion: 'Brazil', runnerUp: 'Sweden', historicMoment: 'A King is Born', keyPlayer: 'Pelé', finalScore: '5-2', story: 'A 17-year-old Pelé announced himself to the world, leading Brazil to their first World Cup triumph with dazzling skill.', image: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Brazilian_team_1958_champions.jpg' },
  { year: 1962, host: 'Chile', champion: 'Brazil', runnerUp: 'Czechoslovakia', historicMoment: 'Garrincha’s Show', keyPlayer: 'Garrincha', finalScore: '3-1', story: 'With Pelé injured early, Garrincha stepped up to conduct an unplayable symphony that secured back-to-back titles.', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b3/Brazil_1962_champion.jpg' },
  { year: 1966, host: 'England', champion: 'England', runnerUp: 'West Germany', historicMoment: 'They Think It’s All Over', keyPlayer: 'Bobby Moore', finalScore: '4-2 (aet)', story: 'Football came home as Geoff Hurst scored a controversial hat-trick in a final forever etched in English folklore.', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1e/Bobby_Moore_with_the_Jules_Rimet_trophy.jpg' },
  { year: 1970, host: 'Mexico', champion: 'Brazil', runnerUp: 'Italy', historicMoment: 'The Beautiful Team', keyPlayer: 'Pelé', finalScore: '4-1', story: 'Often considered the greatest team of all time, the legendary 1970 Brazil squad reached the pinnacle of football aesthetics.', image: 'https://upload.wikimedia.org/wikipedia/commons/5/57/Brazil_1970_champion.jpg' },
  { year: 1974, host: 'West Germany', champion: 'West Germany', runnerUp: 'Netherlands', historicMoment: 'Total Football vs Efficiency', keyPlayer: 'Johan Cruyff', finalScore: '2-1', story: 'The Dutch brought "Total Football" to the world, but West German efficiency prevailed in an iconic ideological clash.', image: 'https://upload.wikimedia.org/wikipedia/commons/4/46/West_Germany_1974_champions.jpg' },
  { year: 1978, host: 'Argentina', champion: 'Argentina', runnerUp: 'Netherlands', historicMoment: 'Ticker Tape in Buenos Aires', keyPlayer: 'Mario Kempes', finalScore: '3-1 (aet)', story: 'Amidst a sea of ticker tape, Mario Kempes inspired the host nation to their maiden World Cup victory.', image: 'https://upload.wikimedia.org/wikipedia/commons/3/36/Argentina_1978_champion.jpg' },
  ...
  { year: 1986, host: 'Mexico', champion: 'Argentina', runnerUp: 'West Germany', historicMoment: 'The Hand of God', keyPlayer: 'Diego Maradona', finalScore: '3-2', story: 'Diego Maradona dominated the tournament like no player before or since, cementing his status as a football god.', image: 'https://upload.wikimedia.org/wikipedia/commons/a/af/Maradona_trophy_1986.jpg' },
  { year: 1990, host: 'Italy', champion: 'West Germany', runnerUp: 'Argentina', historicMoment: 'Nights in Rome', keyPlayer: 'Lothar Matthäus', finalScore: '1-0', story: 'A unified German team ground out a final victory in a tournament defined by tight defenses and dramatic penalty shootouts.', image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/West_Germany_1990_champion.jpg' },
  { year: 1994, host: 'USA', champion: 'Brazil', runnerUp: 'Italy', historicMoment: 'Baggio’s Miss', keyPlayer: 'Romário', finalScore: '0-0 (3-2 p)', story: 'The first final decided by penalties ended with Roberto Baggio\'s tragic miss in the sprawling American stadiums.', image: 'https://upload.wikimedia.org/wikipedia/commons/1/1c/Brazil_1994_champion.jpg' },
  { year: 1998, host: 'France', champion: 'France', runnerUp: 'Brazil', historicMoment: 'Zidane’s Headers', keyPlayer: 'Zinedine Zidane', finalScore: '3-0', story: 'Zinedine Zidane rose to the occasion with two towering headers, securing World Cup glory for the hosts on home soil.', image: 'https://upload.wikimedia.org/wikipedia/commons/8/8c/France_1998_champion.jpg' },
  { year: 2002, host: 'Japan/South Korea', champion: 'Brazil', runnerUp: 'Germany', historicMoment: 'Ronaldo’s Redemption', keyPlayer: 'Ronaldo', finalScore: '2-0', story: 'After the heartbreak of 1998, Ronaldo claimed his redemption by leading Brazil to an unprecedented pentacampeonato.', image: 'https://upload.wikimedia.org/wikipedia/commons/d/db/Brazil_2002_champion.jpg' },
  { year: 2006, host: 'Germany', champion: 'Italy', runnerUp: 'France', historicMoment: 'The Headbutt', keyPlayer: 'Fabio Cannavaro', finalScore: '1-1 (5-3 p)', story: 'A dramatic final marked by Zidane\'s infamous headbutt saw Italy masterfully claim their fourth world title via shootout.', image: 'https://upload.wikimedia.org/wikipedia/commons/d/dc/Italy_2006_champion.jpg' },
  { year: 2010, host: 'South Africa', champion: 'Spain', runnerUp: 'Netherlands', historicMoment: 'Iniesta’s Strike', keyPlayer: 'Andrés Iniesta', finalScore: '1-0 (aet)', story: 'Tiki-taka conquered the world as Spain passed their way to their first star, crowned by Iniesta\'s extra-time winner.', image: 'https://upload.wikimedia.org/wikipedia/commons/b/bf/Spain_2010_champion.jpg' },
  { year: 2014, host: 'Brazil', champion: 'Germany', runnerUp: 'Argentina', historicMoment: '7-1', keyPlayer: 'Thomas Müller', finalScore: '1-0 (aet)', story: 'Following the historic 7-1 dismantling of the hosts, Germany shattered Argentine hearts in extra time at the Maracanã.', image: 'https://upload.wikimedia.org/wikipedia/commons/3/3a/Germany_2014_champion.jpg' },
  { year: 2018, host: 'Russia', champion: 'France', runnerUp: 'Croatia', historicMoment: 'Mbappé Emerges', keyPlayer: 'Luka Modrić', finalScore: '4-2', story: 'A young Kylian Mbappé announced himself on the grandest stage, as a cohesive French squad dismantled the competition.', image: 'https://upload.wikimedia.org/wikipedia/commons/6/60/France_2018_champion.jpg' },
  { year: 2022, host: 'Qatar', champion: 'Argentina', runnerUp: 'France', historicMoment: 'Messi Completes Football', keyPlayer: 'Lionel Messi', finalScore: '3-3 (4-2 p)', story: 'In perhaps the greatest final ever played, Lionel Messi finally lifted the last trophy eluding him, cementing his immortal legacy.', image: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Argentina_2022_champion.jpg' }
];
...
export const legends: Legend[] = [
  ...
  { 
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Cruijff_1974.jpg',
    legacyNumber: '14',
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Ronaldo_Fen%C3%B4meno.jpg',
    legacyNumber: '15',
  ...
  { 
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/f/f3/Zinedine_Zidane_by_Tasnim_1.jpg',
    legacyNumber: '2',
...
export const moments: HistoricalMoment[] = [
  { id: 'miracle-bern', title: 'The Miracle of Bern', description: 'West Germany achieves the impossible, coming back against the Mighty Magyars in the driving rain of Switzerland.', year: 1954, image: 'https://upload.wikimedia.org/wikipedia/commons/9/91/Fritz_Walter_1952.jpg' },
  { id: 'brazil-1970', title: 'The Beautiful Team', description: 'The 1970 Brazil squad reached the pinnacle of football aesthetics, culminating in Carlos Alberto\'s stunning team goal.', year: 1970, image: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Carlos_Alberto_Torres_1970.jpg' },
  { id: 'hand-of-god', title: 'The Hand of God & Goal of the Century', description: 'Diego Maradona writes his own mythology in four minutes against England at the Estadio Azteca.', year: 1986, image: 'https://upload.wikimedia.org/wikipedia/commons/e/eb/Diego_Maradona_contra_Inglaterra_Mundial_1986.jpg' },
  { id: 'mineirazo', title: 'The 7-1 Shock', description: 'A night of disbelief in Belo Horizonte as the hosts are dismantled on their own soil.', year: 2014, image: 'https://upload.wikimedia.org/wikipedia/commons/5/5a/Team_Germany_World_Cup_2014.jpg' },
  { id: 'messis-triumph', title: 'End of a Wait', description: 'One of the greatest finals in history finishes with Lionel Messi finally lifting the trophy in Lusail.', year: 2022, image: 'https://upload.wikimedia.org/wikipedia/commons/b/b4/Lionel-Messi-Argentina-2022-FIFA-World-Cup_%28cropped%29.jpg' }
];
