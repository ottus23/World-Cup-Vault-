...
const nodeDatabase: Record<number, TimeMachineNode> = {
  1930: {
    year: 1930,
    story: "Football steps into a new dawn. In Montevideo’s sweltering July heat, thirteen pioneering nations gathered without qualifiers, traveling weeks by steamships across the Atlantic to inaugurate the world’s grandest sporting theater.",
    champion: "Uruguay",
    runnerUp: "Argentina",
    host: "Uruguay",
    finalScore: "4-2",
    hero: {
      ...
      description: "Entering as a backup striker, Argentine 'El Filtrador' scored a sensational hat-trick on his debut and became the tournament's inaugural Golden Boot king.",
      stats: '8 Goals in 4 Matches'
    },
    definingMatch: {
      title: "Uruguay vs Argentina (The Battle of the Balls)",
      score: "4-2",
      description: "Both nations insisted on using their own matchball. Ultimately, Argentina's ball was used in the first half (Argentina leading 2-1), while Uruguay's heavier ball was used in the second (Uruguay winning 4-2)."
    },
    legacy: "Set the permanent gold standard for intercontinental tournaments and built Estadio Centenario in just nine months as a monument of human speed.",
    atmosphereEmoji: "📜",
    fact: "The tournament did not feature any draws. Every match resulted in a definitive outcome."
  },
  1934: {
    year: 1934,
    story: "Tactics take center stage. Vittorio Pozzo introduced a high-intensity, militaristic focus to training combined with the pioneering 'Metodo' formation, turning the Italian squad into a tactical engine.",
    champion: "Italy",
    ...
    hero: {
      ...
      description: "Italy's first genuine superstar. Known for his tactical intelligence, beautiful playmaking, and outstanding scoring flair in crucial knockout matches.",
      stats: 'Golden Ball Winner'
    },
    definingMatch: {
      title: "Italy vs Czechoslovakia",
      score: "2-1 (aet)",
      description: "Fierce final in Rome. Trailing with 19 minutes left, Orsi scored an incredible curling equalizer, before Schiavio fired home the winner in extra time."
    },
    legacy: "Introduced the fundamental concept of home advantage, intense crowd atmosphere, and qualification stages.",
    atmosphereEmoji: "🏛️",
    fact: "Egypt became the first African nation to compete in a World Cup during this tournament."
  },
  1938: {
    year: 1938,
    story: "With clouds of global conflict gathering over Europe, France hosted a tense, emotionally charged tournament. Defending champions Italy marched through hostile crowds to establish a footballing empire.",
    champion: "Italy",
    runnerUp: "Hungary",
    host: "France",
    finalScore: "4-2",
    hero: {
      ...
      description: "The magnificent Brazilian pioneer. Dubbed 'The Black Diamond', he captured the audience's hearts with acrobatics and pioneered the scissor bicycle kick.",
      stats: '7 Goals (Top Scorer)'
    },
    definingMatch: {
      title: "Brazil vs Poland",
      score: "6-5 (aet)",
      description: "A rain-soaked masterwork in Strasbourg. Leônidas famously took off his boots to play barefoot in the thick mud, scoring an unmatched hat-trick."
    },
    legacy: "Vittorio Pozzo cement-cast his name as the only manager to win back-to-back World Cups, demonstrating defensive perfection.",
    atmosphereEmoji: "🥖",
    fact: "This was the last World Cup for 12 years due to the outbreak of World War II."
  },
  1950: {
    year: 1950,
    story: "A long-awaited resurrection. Brazil built the colossal Maracanã Stadium as a Roman theater for their first crowning. Needing only a single point in the group decider, an entire nation was ready to throw a historic carnival.",
    champion: "Uruguay",
    runnerUp: "Brazil",
    host: "Brazil",
    finalScore: "2-1",
    hero: {
      name: "Obdulio Varela",
      description: "The legendary defensive captain of Uruguay, whose iron-willed composure single-handedly prevented Uruguay from breaking in front of 200,000 hostile fans.",
      stats: 'El Gran Capitán'
    },
    definingMatch: {
      title: "Uruguay vs Brazil (Maracanazo shockwave)",
      score: "2-1",
      description: "Brazil took the lead, but Uruguayan wizard Schiaffino equalized. With 11 minutes left, Ghiggia squeezed a low shot past Friaça, creating absolute silence."
    },
    legacy: "The term 'Maracanazo' entered the human languages as the definitive term for a devastating football upset.",
    atmosphereEmoji: "🏟️",
    fact: "India famously withdrew from the tournament after FIFA banned barefoot play, though travel costs also played a part."
  },
  1954: {
    year: 1954,
    story: "The 'Mighty Magyars' of Hungary were considered the greatest assembly of talent of all time, undefeated for four years. Yet West Germany, utilizing technological genius, mounted an impossible heist in Swiss rains.",
    ...
    hero: {
      name: "Ferenc Puskás",
      description: "The sublime left-footed architect of Hungary, who scored in the final despite carrying a fractured ankle, cementing his status as a footballing titan.",
      stats: 'The Galloping Major'
    },
    definingMatch: {
      title: "West Germany vs Hungary (The Miracle of Bern)",
      score: "3-2",
      description: "Hungary led 2-0 in eight minutes. West Germany, wearing pioneering screw-in stud boots developed by Adi Dassler, gained footing in mud to storm back and win."
    },
    legacy: "Symbolized the spiritual rebirth of post-war Germany, showing the magic of team solidarity and technical ingenuity.",
    atmosphereEmoji: "🏔️",
    fact: "This tournament remains the highest-scoring World Cup in history, averaging an incredible 5.38 goals per game."
  },
  1958: {
    year: 1958,
    story: "A teenager changed football forever. Traveling to Sweden, Brazil combined tactical speed and samba rhythm to unveil a 17-year-old child whose name would define eternity.",
    champion: "Brazil",
    runnerUp: "Sweden",
    host: "Sweden",
    finalScore: "5-2",
    hero: {
      name: "Pelé (Age 17)",
      description: "The youthful King of Football. Scored a hat-trick in the semi-final and a breathtaking brace in the final to take Sweden and the globe by storm.",
      stats: 'Youngest Finals Scorer'
    },
    definingMatch: {
      title: "Brazil vs Sweden",
      score: "5-2",
      description: "In the final, Pelé hit a legendary goal by flicking the ball directly over a defender's head and volleying it into the bottom corner.",
      stats: "Unreal Dribbling Showcase"
    },
    legacy: "Established Brazil as the ultimate spiritual homeland of beautiful play (O Jogo Bonito) and began the golden age of worldwide television broadcasts.",
    atmosphereEmoji: "👑",
  ...
  1962: {
    year: 1962,
    story: "A physically brutal tournament in Chile. When Pelé suffered a tournament-ending muscle tear in the second group game, Brazil’s dynasty seemed vulnerable, until the 'Bent-Legged Angel' stepped up.",
    champion: "Brazil",
    runnerUp: "Czechoslovakia",
    host: "Chile",
    finalScore: "3-1",
    hero: {
      name: "Garrincha",
      description: "The ultimate dribbler of Brazil. Born with deformed legs, his impossible balance made him unplayable, scoring braces in the quarters and semis.",
      stats: 'Golden Ball & Boot'
    },
    definingMatch: {
      title: "Brazil vs England",
      score: "3-1",
      description: "Quarterfinal masterwork. Garrincha scored a bullet header, set up another, and hit an impossible curling banana-shot past English hands."
    },
    legacy: "Unified defensive systems were introduced to contain solo talents, signaling the shift to more structural speed.",
    atmosphereEmoji: "🍷",
  ...
  1966: {
    year: 1966,
    story: "Football comes home. Hosted in Wembley’s majestic shadows, England built an unbreakable defensive force around Bobby Moore, culminating in the most analyzed refereeing decision in human history.",
    champion: "England",
    ...
    hero: {
      name: "Bobby Moore",
      description: "The elegant captain. Never a sliding defender, his tackling lay in supreme reading of the field and immaculate forward transitions.",
      stats: 'Sovereign Leader'
    },
    definingMatch: {
      title: "England vs West Germany",
      score: "4-2 (aet)",
      description: "In extra time, Hurst's shot hit the bar and bounded onto the line. Assarov, the referee's assistant, ruled it a goal, triggering debates for 60 years."
    },
    legacy: "Brought English football its only star and introduced iconic stadium banners, matches of theatrical scale, and press coverage.",
    atmosphereEmoji: "🦁",
  ...
  1970: {
    year: 1970,
    story: "The zenith of pure play. Mexico hosted the first World Cup broadcast in full, glorious living color. On high-heat pitches, Pelé returned to conduct what remains the most beautiful team ever assembled.",
    champion: "Brazil",
    runnerUp: "Italy",
    host: "Mexico",
    finalScore: "4-1",
    hero: {
      name: "Pelé (Peak)",
      description: "His absolute career coronation. Claiming his third winner medal with headers, passes, and near-misses that remain the hallmark of pure footballing art.",
      stats: 'The Greatest of All Time'
    },
    definingMatch: {
      title: "Brazil vs Italy (The Perfect Coronate Final)",
      score: "4-1",
      description: "A nine-pass symphony ending in Pelé throwing a blind pass wide right to charging captain Carlos Alberto, who struck a rocket of sheer beauty."
    },
    legacy: "Remains the absolute gold standard for offensive play, forever linking football with samba art.",
    atmosphereEmoji: "🇲🇽",
  ...
  1974: {
    year: 1974,
    story: "An ideological revolution. Cruyff’s Netherlands introduced 'Total Football'—a system where any player could swap positions dynamically. In the host nation, they met German tactical rigidity in a clash of intellects.",
    champion: "West Germany",
    ...
    hero: {
      name: "Johan Cruyff",
      description: "The intellectual conductor. Dazzled with speed, turn techniques, and spatial choreography that redefined the modern midfielder.",
      stats: 'Golden Ball Icon'
    },
    definingMatch: {
      title: "Netherlands vs West Germany",
      score: "1-2",
      description: "In the first minute, Netherlands put together 17 passes before Cruyff was tripped for a penalty. Germany equalized, and Gerd Müller poked home the winner."
    },
    legacy: "Integrated dynamic space, spatial orientation, and movement into tactical structures.",
    atmosphereEmoji: "🥨",
  ...
  1978: {
    year: 1978,
    story: "In a highly politicized tournament, the warm skies of Buenos Aires were blanketed in a rain of white ticker-tape ticker papers cascading from roaring stands as hosts Argentina claimed their first star.",
    champion: "Argentina",
    runnerUp: "Netherlands",
    host: "Argentina",
    finalScore: "3-1 (aet)",
    hero: {
      name: "Mario Kempes",
      description: "The tall, long-locked talisman. Combining relentless energy and lethal left-footed power, he finished as top scorer and Golden Ball holder.",
      stats: '6 Goals (Golden Ball & Boot)'
    },
    definingMatch: {
      title: "Argentina vs Netherlands",
      score: "3-1 (aet)",
      description: "A brutal, deafening final at Estadio Monumental. Kempes scored twice, sliding through defenders, sealing Argentina's maiden victory.",
      stats: "Extra-time Triumph"
    },
    legacy: "Began Argentina's rise as a global powerhouse of modern soccer with dramatic visual aesthetics.",
    atmosphereEmoji: "🇦🇷",
  ...
  1982: {
    year: 1982,
    story: "Hosted in beautiful Spain, this tournament became a collision of brilliant artistic philosophies. Brazil brought a magnificent midfield of Socrates and Zico, but Italy's direct counter-attacks proved fatal.",
    champion: "Italy",
    runnerUp: "West Germany",
    host: "Spain",
    finalScore: "3-1",
    hero: {
      name: "Paolo Rossi",
      description: "Italy's ultimate poacher. Returning from suspension, he caught lightning in a bottle, scoring six crucial goals in the final stages.",
      stats: '6 Goals (Golden Ball & Boot)'
    },
    definingMatch: {
      title: "Italy vs Brazil (The Day Football Died)",
      score: "3-2",
      description: "The greatest second-round match in history. Rossi scored an iconic hat-trick to dismantle Brazil's legendary samba midfielders.",
      stats: "Dramatic Classic"
    },
    legacy: "Cemented the modern counter-attacking blueprint (Catenaccio and beyond) as defense transitioned to attack.",
    atmosphereEmoji: "🇪🇸",
  ...
  1986: {
    year: 1986,
    story: "One man conquers history. On Azteca's high-altitude stages, Diego Armando Maradona put on a displays of skill, intelligence, and street cunning that will never be matched in human history.",
    champion: "Argentina",
    runnerUp: "West Germany",
    host: "Mexico",
    finalScore: "3-2",
    hero: {
      name: "Diego Maradona",
      description: "The sublime Cosmic Kite. Led his team with unbelievable direct goalscoring, solo runs, and majestic tactical playmaking.",
      stats: '5 Goals & 5 Assists (Golden Ball)'
    },
    definingMatch: {
      title: "Argentina vs England (The Hand and the Century)",
      score: "2-1",
      description: "Within four minutes, Maradona scored using the controversial 'Hand of God', then dribbled past five English players from his own half to hit the 'Goal of the Century'."
    },
    legacy: "Immortalized Maradona as a footballing deity and established Azteca as a modern temple of sporting drama.",
    atmosphereEmoji: "🌪️",
    fact: "This tournament popularized 'The Wave' in stadiums, making it a permanent part of international sporting experience."
  },
  1990: {
    year: 1990,
    story: "A defensive tournament soundscaped by Pavarotti’s haunting 'Nessun Dorma'. On warm Italian nights, Germany’s structured midfield engine engineered a tactical march through tight defensive structures.",
    champion: "West Germany",
    runnerUp: "Argentina",
    host: "Italy",
    finalScore: "1-0",
    hero: {
      ...
      description: "The complete German captain. Capable of driving, direct overlapping runs, and dictating play from deep areas.",
      stats: 'Silver Ball Winner'
    },
    definingMatch: {
      title: "West Germany vs England (The penalty shootout curse)",
      score: "1-1 (4-3 p)",
      description: "A tense semifinal in Turin. Lineker scored the late equalizer, and Germany progressed via a penalty shootout, beginning England's shootout heartache.",
      stats: "Unreal Drama"
    },
    legacy: "Prompted a critical revision of rules—including the introduction of three points for wins and banning backpasses to goalkeepers.",
    atmosphereEmoji: "🇮🇹",
    fact: "Roger Milla (Cameroon) celebrated his goals by dancing with the corner flag at age 38, captivating fans globally."
  },
  1994: {
    year: 1994,
    story: "The World Cup crossed into North America. Giant, sun-drenched sports bowls saw rapid, attacking plays in front of massive, celebratory crowds, concluding in Pasadena's dry, hot air.",
    champion: "Brazil",
    runnerUp: "Italy",
    host: "USA",
    ...
    hero: {
      name: "Romário",
      description: "The clinical master of the box. Possessing incredible speed over small spaces and sublime finishing calmness.",
      stats: 'Golden Ball Winner'
    },
    definingMatch: {
      title: "Brazil vs Italy (The Tragedy of the Rose Bowl)",
      score: "0-0 (3-2 p)",
      description: "After carrying an injured Italy to the final, Roberto Baggio stepped up in Pasadena heat, only to put his shootout penalty high into the sky."
    },
    legacy: "Broke the all-time attendance models, introducing millions of North Americans to professional soccer.",
    atmosphereEmoji: "🗽",
    fact: "Roger Milla broke his own record, scoring at 42 years old, making him the oldest goalscorer in World Cup history."
  },
  1998: {
    year: 1998,
    story: "A modern revolution of identity. Hosted in France, a multicultural and unified 'One France' team combined football strength and creative elegance to claim their inaugural star.",
    champion: "France",
    runnerUp: "Brazil",
    host: "France",
    finalScore: "3-0",
    hero: {
      ...
      description: "The balletic giant. Facing tremendous pressure on home soil, he rose above corners in the final to seal French history.",
      stats: '2 Goals in Final'
    },
    definingMatch: {
      title: "France vs Brazil",
      score: "3-0",
      description: "Ronaldo suffered a mystery seizure hours before kickoff. Zidane struck two towering headers from corners, sending St. Denis into absolute euphoria."
    },
    legacy: "United a Nation under a multi-racial banner and modernized the brand of physical playmaking.",
    atmosphereEmoji: "🥐",
    fact: "Croatia debuted in this World Cup post-independence and achieved a stunning 3rd place finish, led by Davor Šuker."
  },
  2002: {
    year: 2002,
    story: "The first World Cup in Asia, defined by surprises and massive, chanting crowds. It became the stage for one of football's greatest redemption stories.",
    champion: "Brazil",
    runnerUp: "Germany",
    ...
    hero: {
      ...
      description: "O Fenômeno. Overcoming years of career-ending knee reconstructions, he returned with a triangular haircut to score 8 golden goals.",
      stats: '8 Goals (Golden Boot)'
    },
    definingMatch: {
      title: "Brazil vs Germany",
      score: "2-0",
      description: "In the Yokohama final, Ronaldo capitalized on Oliver Kahn's spill, then struck a low shot in the bottom corner to seal the match."
    },
    legacy: "Confirmed Brazil's status as a 5-star football civilization (the Pentacampeão) in high-tech stadiums.",
    atmosphereEmoji: "⛩️",
    fact: "Hakan Şükür (Turkey) scored the fastest goal in World Cup history after just 10.8 seconds against South Korea."
  },
  2006: {
    year: 2006,
    story: "A highly defensive, star-studded tournament in Germany. Under unified, premium branding, Italian defensive stability and midfield coordination forged a path to glory under dramatic circumstances.",
    champion: "Italy",
    runnerUp: "France",
    host: "Germany",
    ...
    hero: {
      ...
      description: "The Berlin Wall. Despite standing just 5'9\", his perfect timing, positioning, and leadership earned him the Ballon d'Or as a defender.",
      stats: 'Captain & Silver Ball'
    },
    definingMatch: {
      title: "Italy vs France (Tragedy in Berlin)",
      score: "1-1 (5-3 p)",
      description: "Playing his final game, Zidane opened with a cheeky penalty, but Marco Materazzi equalized. In extra time, Zidane headbutted Materazzi after a provocation, receiving a red card."
    },
    legacy: "Remains an iconic broadcast-era event, defining the retirement of a brilliant generation of modern masters.",
    atmosphereEmoji: "🍻",
  ...
  2010: {
    year: 2010,
    story: "The first World Cup on African soil, soundtracked by vuvuzelas and Shakira's 'Waka Waka'. Spain’s Tiki-Taka pass-and-move carousel wore down opponents to write history in golden colors.",
    champion: "Spain",
    runnerUp: "Netherlands",
    host: "South Africa",
    finalScore: "1-0 (aet)",
    hero: {
      name: "Andrés Iniesta",
      description: "The quiet conductor of Tiki-Taka, who moved into pockets with ball control and unlocked the final's bruising deadlock.",
      stats: 'Golden Ball Final MVP'
    },
    definingMatch: {
      title: "Spain vs Netherlands",
      score: "1-0 (aet)",
      description: "In a physical final in Johannesburg with 14 yellow cards, Iniesta slammed home Fabregas's layout pass in the 116th minute, dedicating it to late friend Dani Jarque."
    },
    legacy: "Tiki-Taka entered the history books as a tactical school that dominated both club and international platforms.",
    atmosphereEmoji: "🎺",
    fact: "This was the first time the host country was eliminated in the first round of the competition."
  },
  2014: {
    year: 2014,
    story: "Returning to Brazil, a carnival of pure speed and goals unfolded. But Germany's engineered tactical unity would deliver a brutal, historic shockwave to the hosts on their own holy ground.",
    champion: "Germany",
    runnerUp: "Argentina",
    host: "Brazil",
    finalScore: "1-0 (aet)",
    hero: {
      name: "Miroslav Klose",
      description: "The veteran target man. By scoring in the historic semifinal, he became the all-time leading scorer in World Cup history.",
      stats: '16 All-Time Goals'
    },
    definingMatch: {
      title: "Germany vs Brazil (The Mineirazo)",
      score: "7-1",
      description: "In Belo Horizonte, Germany scored five times in the opening 29 minutes, delivering a tragic shock to an entire host nation."
    },
    legacy: "German tactical systems set a new benchmark for counter-pressing, ending in Mario Götze's brilliant chest-and-volley winner in Rio.",
    atmosphereEmoji: "🌴",
    fact: "Germany became the first European team to win a World Cup in the Americas."
  },
  2018: {
    year: 2018,
    story: "A fast, transition-centered tournament. France, built around the speed of Kylian Mbappé and the midfield structure of N'Golo Kanté, marched through opponents with pragmatic efficiency.",
    champion: "France",
    runnerUp: "Croatia",
    host: "Russia",
    finalScore: "4-2",
    hero: {
      name: "Luka Modrić",
      description: "The tireless Croatian engine. Dragg'd a nation of four million to the final, showing midfield vision, stamina, and captaincy.",
      stats: 'Golden Ball Winner'
    },
    definingMatch: {
      title: "France vs Croatia",
      score: "4-2",
      description: "A thriller final in Moscow. France scored via an own goal, penalty, and strikes from Pogba and Mbappé, while Croatia fought heroically.",
      stats: "Modern High Score Final"
    },
    legacy: "Introduced VAR to football history, changing defensive setups and penalty statistics forever.",
    atmosphereEmoji: "🏰",
    fact: "Kylian Mbappé became only the second teenager to score in a World Cup final, after Pelé in 1958."
  },
  2022: {
    year: 2022,
    story: "The ultimate crowning. Set against Qatar’s winter skies, Lionel Messi embarked on a final mission. Over seven high-pressure matches, he led Argentina in what became a cinematic conquest of soccer divinity.",
    champion: "Argentina",
    runnerUp: "France",
    host: "Qatar",
    ...
    hero: {
      name: "Lionel Messi",
      description: "The immortal master of Rosario. Scored in every single knockout stage, claiming his desired crown.",
      stats: 'Golden Ball Winner'
    },
    definingMatch: {
      title: "Argentina vs France (The Greatest Final)",
      score: "3-3 (4-2 p)",
      description: "Argentina led 2-0; Mbappé hit a 97-second brace. Messi scored in extra time; Mbappé matched with a penalty. Penalties decided Messi's absolute crowning."
    },
    legacy: "Cemented Lionel Messi as the greatest footballer in history and completed his epic trophy collection.",
    atmosphereEmoji: "✨",
    fact: "This World Cup saw a record-breaking 172 goals scored, surpassing the 171 of both 1998 and 2014."
  },
  2026: {
    year: 2026,
    story: "Expanding to an unprecedented 48 nations across three massive co-host countries, the 2026 World Cup starts a new frontier of scale, theatricality, and global unity.",
    ...
    hero: {
      ...
      description: "Brilliant young athletes stepping into the grandest lights across North America, ready to write their own mythology.",
      stats: '48 Nations Peak'
    },
    definingMatch: {
      title: "104 Matches of Scale",
      score: "Pan-Continental",
      description: "Setting foot in 16 venues from Mexico City's historic Azteca to New York, the scale introduces an unmatched crucible of soccer drama."
    },
    legacy: "The first tri-national co-hosted tournament, expanding the sport's global footprint permanently.",
    atmosphereEmoji: "🚀",
...
export function TimeMachine({ 
  ...
  const [activePath, setActivePath] = useState<'tournaments' | 'nations' | 'legends' | 'records' | 'stadiums'>('tournaments');
  ...
  const yearsList = [1930, 1934, 1938, 1950, 1954, 1958, 1962, 1966, 1970, 1974, 1978, 1982, 1986, 1990, 1994, 1998, 2002, 2006, 2010, 2014, 2018, 2022, 2026];
    ...
    if (year <= 1950) {
      return {
        ...
        styles: {
          ...
          texture: 'bg-[radial-gradient(#3a2e21_1px,transparent_1px)] [background-size:16px_16px] opacity-15'
        }
      };
    } else if (year <= 1978) {
      return {
        ...
        styles: {
          ...
          decorBg: 'bg-[#291f0c]',
          borderClass: 'border-2 border-[#D4AF37]/45 rounded-lg p-6 shadow-[0_0_30px_rgba(212,175,55,0.04)]',
          fontClass: 'font-serif',
          tagClass: 'text-[9px] font-mono tracking-[0.25em] text-[#AFA58D] font-bold',
          headerGlow: 'shadow-[0_0_60px_rgba(212,175,55,0.08)]',
          texture: 'bg-[linear-gradient(45deg,#291f0a_25%,transparent_25%,transparent_75%,#291f0a_75%,#291f0a)] [background-size:30px_30px] opacity-10'
        }
      };
    } else if (year <= 2006) {
      return {
        ...
        styles: {
          ...
          decorBg: 'bg-[#0f1424]',
          borderClass: 'border border-[#18233c] rounded-sm p-6 relative before:absolute before:inset-0 before:bg-[linear-gradient(rgba(24,35,60,0)_95%,_rgba(62,186,255,0.08)_95%)] before:bg-[size:100%_8px] before:pointer-events-none',
          ...
          texture: 'bg-[linear-gradient(rgba(6,8,16,0.3)_50%,_rgba(0,0,0,0.4)_50%)] bg-[size:100%_4px] opacity-25'
        }
      };
    } else {
      return {
        ...
        styles: {
          ...
          accentText: 'text-[#D4AF37]',
          decorBg: 'bg-[#141416]',
          borderClass: 'border border-[#2d2d32] rounded-none p-6 shadow-2xl shadow-black',
          fontClass: 'font-sans',
          tagClass: 'text-[8px] font-mono tracking-[0.4em] text-[#A1A1A4]',
          headerGlow: 'shadow-[0_0_60px_rgba(212,175,55,0.05)]',
          texture: 'bg-[radial-gradient(#1c1c1f_1px,transparent_1px)] [background-size:20px_20px] opacity-35'
        }
      };
    }
  }
  ...
  const pathConfig = {
    ...
    records: {
      subpaths: [
        { id: 'all', label: 'Unbelievable Records' }
      ]
    },
    stadiums: {
      subpaths: [
        { id: 'all', label: 'Coliseum Landmarks' }
      ]
    }
  };
  ...
  function getFilteredYears() {
    ...
    if (activePath === 'nations') {
      ...
      return [1934, 1938, 1954, 1958, 1962, 1970, 1974, 1978, 1982, 1986, 1990, 1994, 2002, 2006, 2014, 2022];
    }
  ...
  const fractureDetails: Record<number, { title: string; subtitle: string; desc: string; graphicText: string }> = {
    1958: {
  ...
  const activeFractureData = activeFracture !== null ? fractureDetails[activeFracture] : null;
                ...
                {yearsList.map((y, idx) => (
                  <motion.span
                    ...
                    className={`font-serif text-xs md:text-sm font-bold tracking-wider ${
                      idx < introStep ? 'opacity-85 text-[#D4AF37]' : 'opacity-0 text-gray-800'
          ...
          >
            ...
            <header className="px-6 md:px-12 py-5 border-b border-white/5 bg-black/45 backdrop-blur-md flex justify-between items-center z-40 relative">
              <div className="flex items-center gap-4">
                ...
                >
                  <ArrowLeft size={14} className="group-hover/back:-translate-x-1.5 transition-transform" />
              ...
              <div className="hidden md:flex flex-col items-center text-center">
                <span className="font-mono text-[8px] text-[#AFA58D] tracking-[0.3em] uppercase mb-0.5 font-bold">
                  ERA {activeYear <= 1950 ? 'I' : activeYear <= 1978 ? 'II' : activeYear <= 2006 ? 'III' : 'IV'} // TRAVEL ENVELOPE
                </span>
                <span className={`font-serif text-xs md:text-sm italic uppercase font-black tracking-widest ${currentSetup.styles.accentText} transition-all duration-500`}>
            ...
            <div className="px-6 md:px-12 py-3 border-b border-white/5 bg-black/20 flex flex-wrap gap-2 md:gap-4 items-center justify-between z-30 relative scrollbar-none">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[9px] tracking-wider text-[#AFA58D] uppercase font-bold mr-2">CHRONICLE AXIS:</span>
            ...
            <AnimatePresence>
              {showHelp && (
                <motion.div 
                  ...
                  exit={{ opacity: 0, y: -10 }}
                >
                  <p className="font-bold text-[#D4AF37] mb-2 font-serif text-sm">ARCHIVAL KEYBOARD CONTROLS</p>
                  <ul className="space-y-1">
                    <li><strong className="text-white">← Left Arrow:</strong> Step backward in time</li>
                    <li><strong className="text-white">→ Right Arrow:</strong> Step forward in time</li>
                    <li><strong className="text-white">Esc Key:</strong> Sift back to Vault lobby</li>
                  </ul>
                  <button 
            ...
            <div className="flex-1 flex flex-col justify-center items-center px-6 md:px-12 relative overflow-hidden h-full">
              ...
              <div className={`absolute inset-0 transition-colors duration-1000 select-none pointer-events-none -z-10 ${currentSetup.styles.texture}`} />
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none opacity-[0.03] transition-opacity duration-1000 -z-10">
                <span className={`font-black text-[38vw] leading-none text-[#F5F2EA] ${reducedMotion ? '' : 'animate-pulse'}`}>
                  {activeYear}
                </span>
              </div>
              ...
              <div className="absolute top-4 left-6 right-6 flex items-center justify-between text-[#8E8B83]/45 tracking-widest font-mono text-[8.5px] uppercase select-none pointer-events-none border-b border-white/5 pb-2 hidden lg:flex">
                ...
                <div className="flex items-center gap-2">
                  <span className={activeYear >= 1958 ? 'text-[#D4AF37] font-bold' : ''}>1958 CORONATION (PELÉ)</span>
                  <span>→</span>
                  <span className={activeYear >= 1986 ? 'text-[#D4AF37] font-bold' : ''}>1986 SOLO GENIUS (MARADONA)</span>
                  <span>→</span>
                  <span className={activeYear >= 2022 ? 'text-[#D4AF37] font-bold' : ''}>2022 SOVEREIGN DIGNITY (MESSI)</span>
                </div>
              </div>
              ...
              <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center z-13 relative py-6">
                ...
                <div className="col-span-1 lg:col-span-5 flex justify-center w-full">
                  <motion.div 
                    ...
                    initial={reducedMotion ? { opacity: 0 } : { opacity: 0, x: -50, scale: 0.95 }}
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start border-b border-[#4E5661]/15 pb-3">
                      <div>
                        <span className={`${currentSetup.styles.tagClass} uppercase block mb-0.5 font-bold`}>
                          DESTINATION CARD NUMÉRO {activeYear}
                        </span>
                        <h3 className="font-serif text-[#F5F2EA] text-2xl font-black">{activeYear}</h3>
                      </div>
                      <span className="text-2xl opacity-80">{activeNode.atmosphereEmoji}</span>
                    </div>
                    ...
                    <div className="relative aspect-[4/3] rounded-sm overflow-hidden border border-white/5">
                      ...
                      <div className="absolute bottom-3 left-3">
                        <span className="font-mono text-[8px] text-[#AFA58D] block uppercase tracking-widest leading-none mb-1">HOST NATION</span>
                        <span className="font-serif font-black text-white text-md uppercase tracking-wider">{activeNode.host}</span>
                      </div>
                    </div>
                    ...
                    <div className="p-3.5 bg-black/40 border border-white/5 rounded-xs mt-1">
                      <div className="flex items-center gap-2 mb-1">
                        <Trophy size={14} className={currentSetup.styles.accentText} />
                        <span className="font-mono text-[8.5px] uppercase text-[#AFA58D] tracking-widest font-black">CROWNED CHAMPIONS</span>
                      </div>
                      ...
                      {activeYear !== 2026 && (
                        <p className="font-sans text-[10px] text-[#69707A] font-light mt-0.5">
                          Silver: {activeNode.runnerUp} • Final Match Count: {activeNode.finalScore}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="flex items-start gap-2 text-[10px] text-[#8E8B83] mt-1 leading-relaxed opacity-85">
                      <Zap size={11} className="text-[#D4AF37] mt-0.5 flex-shrink-0" />
                      <p className="font-sans italic font-light">{activeNode.fact}</p>
                    </div>
                  </motion.div>
                </div>
                ...
                <div className="col-span-1 lg:col-span-7 flex flex-col justify-center">
                  ...
                  <motion.div 
                    ...
                    className="mb-4"
                  >
                    <span className={`font-mono text-[9px] ${currentSetup.styles.accentText} tracking-[0.35em] font-black uppercase mb-1.5 block`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mb-6">
                    ...
                    >
                      <div className="flex items-center gap-1.5 mb-2 border-b border-white/5 pb-1.5">
                        <User size={13} className={currentSetup.styles.accentText} />
                        <span className="font-mono text-[8px] text-[#AFA58D] font-black uppercase tracking-widest">CHAPTER TITAN HERP</span>
                      </div>
                    ...
                    >
                      <div className="flex items-center gap-1.5 mb-2 border-b border-white/5 pb-1.5">
                        <Clock size={13} className={currentSetup.styles.accentText} />
                        <span className="font-mono text-[8px] text-[#AFA58D] font-black uppercase tracking-widest">DEFINING CLASH</span>
                      </div>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                              <span className="font-mono text-[8px] text-red-400 tracking-widest uppercase font-black block">FRACTURED INSTANT DETECTED IN TIMELINE</span>
                              <span className="font-serif text-[11px] text-[#F1EBE0] font-bold uppercase tracking-wider group-hover:text-red-300 transition-colors">
                                Explore Time Fracture: "{fractureDetails[activeYear]?.title}"
                              </span>
                            </div>
                          </div>
                  ...
                  <div className="flex flex-wrap gap-2.5 items-center mt-6 max-w-2xl border-t border-white/5 pt-5 select-none z-10">
                    <span className="font-mono text-[8.5px] text-[#69707A] tracking-wider uppercase font-bold mr-1">EXHIBITION SHORTCUTS:</span>
                    
                    <button 
                      onClick={() => {
                        const recNameClass = activeYear === 1930 ? 'First Ever World Cup Goal' : activeYear === 1950 ? 'All-Time Attendance Monument' : activeYear === 2022 ? 'Most World Cup Matches Played' : '';
                      ...
                      <button 
                        onClick={() => {
                          if (onExploreClassicMatch) {
                            ...
                            onExploreClassicMatch(mtchMap[activeYear] || '2022-argentina-france');
                          }
                        }}
                ...
                <div className="flex-1 max-w-2xl px-6 py-2 overflow-x-auto scrollbar-none flex justify-between gap-4 items-center border border-white/5 bg-black/35 rounded-xs p-1">
                  {activeYears.map(year => {
                    ...
                    return (
                      ...
                      >
                        <span className={`font-serif text-[11px] font-black ${
                          isSelected 
                        ...
                        <div className={`w-1 h-1 rounded-full mt-1 ${
                          isSelected ? 'bg-[#D4AF37] animate-pulse' : 'bg-transparent'
                        }`} />
                      </button>
                    );
                  })}
              ...
              {activeFractureData && (
                ...
                >
                  ...
                  <motion.div 
                    ...
                    initial={reducedMotion ? { scale: 1 } : { scale: 0.94, y: 15 }}
                    animate={{ scale: 1, y: 0 }}
