...
function getEraStyling(year: number) {
  if (year <= 1950) {
    return {
      filterClass:
        "sepia-[0.5] grayscale-[0.2] contrast-[1.1] brightness-90 saturate-75",
  ...
  if (year <= 2006) {
    return {
      filterClass:
        "contrast-[1.25] saturate-[1.3] brightness-95 hue-rotate-[5deg]",
...
export function TournamentArchive({
  ...
  const [commentarySnippet, setCommentarySnippet] = useState<CommentarySnippet>(
    () => getDefaultCommentary(tournament.year),
  );
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-end gap-1 h-5 w-16 px-1">
            {!audioMuted ? (
              <>
                <div
                  className="w-1 bg-[#D4AF37]/75 rounded-sm animate-[bounce_0.8s_infinite_0.1s] h-1.5"
                  style={{ animationDuration: "0.6s" }}
                ></div>
                <div
                  className="w-1 bg-[#D4AF37]/75 rounded-sm animate-[bounce_0.8s_infinite_0.2s] h-4"
                  style={{ animationDuration: "0.8s" }}
                ></div>
                <div
                  className="w-1 bg-[#D4AF37]/75 rounded-sm animate-[bounce_0.8s_infinite_0.3s] h-2.5"
                  style={{ animationDuration: "0.5s" }}
                ></div>
                <div
                  className="w-1 bg-[#D4AF37]/75 rounded-sm animate-[bounce_0.8s_infinite_0.4s] h-3.5"
                  style={{ animationDuration: "0.7s" }}
                ></div>
                <div
                  className="w-1 bg-[#D4AF37]/75 rounded-sm animate-[bounce_0.8s_infinite_0.5s] h-1"
          ...
          <div className="hidden sm:flex flex-col gap-1">
            <span className="font-sans text-[9px] uppercase tracking-widest text-[#69707A] font-semibold">
              Stadium Soundscape
            </span>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Radio
              size={14}
              className={
                isSpeaking ? "text-[#D4AF37] animate-pulse" : "text-[#69707A]"
              }
            />
      ...
      <section className="relative min-h-screen w-full flex flex-col justify-end pb-24 md:pb-32 overflow-hidden px-6 md:px-12">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-12">
          <div className="w-full md:w-2/3 mt-32 md:mt-0">
            ...
            >
              ...
              <span className="text-[#D4AF37] font-bold">
                {tournament.year} PORTFOLIO DOCUMENT
              </span>
            </motion.div>
          ...
          >
            <div>
              <p className="font-sans text-[10px] text-[#69707A] uppercase tracking-widest mb-1">
                Teams
              </p>
              <p className="font-serif text-[#F5F2EA] text-xl font-medium">
                {details.teamsCount} Contenders
              </p>
            </div>
            <div>
              <p className="font-sans text-[10px] text-[#69707A] uppercase tracking-widest mb-1">
            ...
            <div>
              ...
              <p className="font-serif text-[#F5F2EA] text-xl font-medium">
                {details.goldenBoot} ({details.goldenBootGoals})
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative w-full bg-[#0a0a0a] py-20 px-6 border-y border-[#4E5661]/10 flex flex-col items-center">
        <div className="max-w-4xl w-full">
          ...
          >
            ...
            <h2 className="font-serif text-[#F5F2EA] text-3xl md:text-4xl mb-3 tracking-wide">
              Tournament Time Capsule
            </h2>
              ...
              {timeCapsuleSealed ? (
                ...
                >
                  <p className="font-serif italic text-lg text-[#DDD7C8]/70 mb-8 max-w-xl mx-auto">
                    "Sealed deep in the football chronicle vaults, holding the
                    definitive facts of the {tournament.year} tournament."
                  </p>
                  <button
                ...
                >
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                      Champion Team
                    </p>
                    <p className="font-serif text-[#F5F2EA] text-lg">
                      {details.capsule?.champion || tournament.champion}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                    ...
                    <p className="font-serif text-[#F5F2EA] text-lg">
                      {details.capsule?.runnerUp || tournament.runnerUp}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                    ...
                    <p className="font-serif text-[#F5F2EA] text-lg">
                      {details.capsule?.host || tournament.host}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                      Tournament MVP (Golden Ball)
                    </p>
                    <p className="font-serif text-[#F5F2EA] text-lg">
                      {details.capsule?.mvp || details.goldenBall}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                    ...
                    <p className="font-serif text-[#F5F2EA] text-lg">
                      {details.capsule?.topScorer ||
                        `${details.goldenBoot} (${details.goldenBootGoals} Goals)`}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 border border-white/5">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1 font-semibold">
                      Defining Legacy Moment
                    </p>
                    <p className="font-serif text-[#F5F2EA] text-sm line-clamp-2">
                      {details.capsule?.definingMoment ||
                        tournament.historicMoment}
                    </p>
                  </div>
                  <div className="sm:col-span-2 md:col-span-3 p-4 bg-white/5 border border-white/10 mt-2">
                    <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-2 font-semibold">
                      Historical Significance
                    </p>
                    <p className="font-serif text-[#DDD7C8] text-sm leading-relaxed italic">
                      "
                      {details.capsule?.historicalSignificance ||
                        "Determined tactical paradigms and highlighted beautiful individual runs for a global following."}
                      "
                    </p>
                  </div>
      ...
      <section className="relative w-full bg-[#0a0a0a] py-32 px-6 md:px-12 border-t border-[#4E5661]/10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <Trophy
            size={48}
            className="text-[#D4AF37] mx-auto mb-10 opacity-70"
            strokeWidth={1}
          />
          <p className="font-sans text-[#D4AF37] tracking-[0.2em] uppercase text-[10px] mb-8 font-semibold">
            Chapter II • The Epic Narrative
          </p>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[#4E5661]/25 pb-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-serif text-[#F5F2EA] text-lg font-bold tracking-wide">
                    Archival Radio Transceiver
                  </h3>
                  <span className="font-sans text-[9px] uppercase tracking-widest text-[#69707A] font-semibold">
                    Shortwave Band • Simulating {tournament.year} sound
                    frequencies
                  </span>
                </div>
              </div>
            ...
            <p className="font-serif text-[#DDD7C8] text-xs leading-relaxed italic opacity-80 mb-6">
              Step inside the stadium chronicle. Experience synthesized live
              spectator crowd murmurs, triggering acoustic chanting surges or
              invoking historic broadcast highlights.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
              {/* Transceiver Controls column */}
              <div className="flex flex-col gap-3 justify-center">
                <p className="font-sans text-[9px] uppercase tracking-widest text-[#69707A] font-bold">
                ...
                >
                  <span>
                    {isSpeaking ? "Mute Active Voice" : `Tune Broadcast`}
                  </span>
                  <Megaphone
                    size={14}
                    className={isSpeaking ? "animate-bounce" : "opacity-60"}
                  />
                </button>
              ...
              <div className="bg-[#090909] p-4 border border-[#4E5661]/15 rounded-sm flex flex-col justify-between">
                <div>
                  <p className="font-sans text-[9px] uppercase tracking-widest text-[#69707A] font-bold mb-2">
                    Radio Status
                  </p>
                  <div className="flex items-center gap-2 mb-4">
                    <span
                      className={`w-2 h-2 rounded-full ${audioMuted ? "bg-[#ff4d4d]" : "bg-[#2ecc71] animate-ping"}`}
                    />
                    <span className="font-mono text-[10px] text-[#DDD7C8]/80">
                      {audioMuted
                        ? "TRANSMITTER SILENCED"
                        : "LIVE ATMOSPHERIC EMISSION"}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between border-t border-[#4E5661]/15 pt-3 mt-3">
                  <div className="flex flex-col gap-1">
                    <span className="font-sans text-[8px] text-[#69707A] uppercase">
                      Volume
                    </span>
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 border font-sans text-[9px] uppercase font-bold tracking-wider transition-all ${
                      audioMuted
                        ? "border-[#ff4d4d]/40 text-[#ff4d4d] bg-[#ff4d4d]/5"
                        : "border-[#4E5661]/35 text-[#69707A]"
                    }`}
                  >
        ...
        if (matchId && onExploreClassicMatch) {
          return (
            <div className="flex justify-center bg-[#0a0a0a] pb-24 px-6 relative z-10">
              ...
              >
                <div>
                  <span className="font-sans text-[8px] tracking-[0.25em] text-[#D4AF37] uppercase font-bold block mb-1">
                    IMMEDIATE TRANSFER AVAILABLE
                  </span>
                  <h4 className="font-serif text-[#F5F2EA] text-md font-bold">
                    Relive the Full Cinematic Match Documentary
                  </h4>
                  <p className="font-sans text-[#7e9ba9] text-[11px] leading-relaxed mt-1">
                    Interact with the Momentum River and timeline chronicles
                    inside the Matches Vault.
                  </p>
                </div>
                <button
      ...
      <section className="relative w-full bg-[#111] py-32 px-6 md:px-12 border-t border-[#4E5661]/10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 flex shrink-0 items-end gap-6 text-left">
            <span className="font-serif text-[#4E5661] text-6xl md:text-8xl leading-none opacity-20">
              03
            </span>
            <div>
              <h2 className="font-serif text-[#F5F2EA] text-4xl md:text-6xl mb-2">
                Group Stage Atlas
              </h2>
              <p className="font-sans text-[#D4AF37] tracking-[0.2em] uppercase text-xs">
                Sealed Cabinet Folders
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <p className="font-sans text-[#69707A] text-[10px] uppercase tracking-widest mb-2 font-medium">
                Select Archival Portfolio
              </p>
              {details.groups.map((group, idx) => (
                ...
                >
                  ...
                  <div>
                    <span className="font-sans text-xs text-[#69707A] uppercase tracking-wider block">
                      Portfolio Case
                    </span>
                    <span className="font-serif text-lg text-[#F5F2EA] font-semibold">
                      {group.name}
                    </span>
                  </div>
                  {activeGroupIndex === idx && (
              ...
              <div className="p-6 border border-[#4E5661]/10 bg-white/[0.02] mt-4 rounded-sm">
                ...
                <p className="font-serif text-xs text-[#69707A] italic leading-relaxed">
                  Unfolding a folder reveals tactical standings, detailed
                  matches, and historical keys of the early stage.
                </p>
              </div>
            </div>
                    ...
                    idx === activeGroupIndex && (
                      ...
                      >
                        <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#4E5661]/20">
                          <h3 className="font-serif text-[#F5F2EA] text-2xl font-bold">
                            {group.name} Chronicle
                          </h3>
                        ...
                        <div className="mb-10">
                          <h4 className="font-sans text-[10px] text-[#69707A] uppercase tracking-widest mb-4 font-semibold">
                            Table Standings
                          </h4>
                            ...
                            {group.standings.map((teamRow, tIdx) => (
                              <div
                                ...
                                className={`grid grid-cols-12 text-sm px-4 py-3 border-b border-white/[0.02] items-center ${
                                  tIdx < 2
                                    ? "bg-white/[0.03] text-[#F5F2EA]"
                                    : "text-[#69707A]"
                                }`}
                              >
                                <div className="col-span-6 font-serif flex items-center gap-3">
                                  <span className="text-[10px] font-sans opacity-40">
                                    {tIdx + 1}
                                  </span>
                                  <span>{teamRow.team}</span>
                                  {tIdx < 2 && (
                                    <span className="text-[9px] font-sans text-[#D4AF37]/80 uppercase px-1.5 py-0.5 border border-[#D4AF37]/20 rounded-sm scale-90">
                                      Qualified
                                    </span>
                                  )}
                                </div>
                                <div className="col-span-2 text-center font-serif">
                                  {teamRow.w}
                                </div>
                                <div className="col-span-2 text-center font-serif">
                                  {teamRow.d}
                                </div>
                                <div className="col-span-2 text-center font-serif font-bold text-[#D4AF37]">
                                  {teamRow.pts}
                                </div>
                              </div>
                            ))}
                        ...
                        <div className="mb-10">
                          ...
                          <div className="space-y-4">
                            {group.matches.map((match, mIdx) => (
                              <div
                                key={mIdx}
                                className="p-4 bg-white/[0.01] border border-white/5 rounded-sm"
                              >
                        ...
                        <div className="p-5 border-l-2 border-[#D4AF37] bg-white/[0.01]">
                          <p className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest mb-1.5 font-semibold">
                            Key Stage Moment
                          </p>
            ...
            {details.roadToGlory.map((match, idx) => (
              ...
              >
                ...
                <div className="flex-1 bg-[#111111] border border-[#4E5661]/20 p-8 md:p-12 group hover:border-[#D4AF37]/50 transition-all rounded-sm shadow-xl">
                  <p className="font-sans text-[#69707A] text-[10px] uppercase tracking-[0.25em] mb-6 font-semibold">
                    {match.stage}
                  </p>

                  <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 mb-8 pb-8 border-b border-[#4E5661]/20">
                    <div>
                      <p className="font-sans text-[#D4AF37] text-[10px] uppercase tracking-widest mb-2 font-semibold">
                        Opponent Matchup
                      </p>
                      <p className="font-serif text-[#F5F2EA] text-2xl sm:text-4xl lg:text-5xl font-bold">
                        {match.opponent}
                      </p>
                    </div>
                    <div className="text-left md:text-right">
                      <p className="font-sans text-[#D4AF37] text-[10px] uppercase tracking-widest mb-2 font-semibold font-medium">
                        Result score
                      </p>
                      <p className="font-serif text-[#DDD7C8] text-3xl sm:text-4xl font-bold">
                        {match.score}
                      </p>
                    </div>
                  </div>
      ...
      <section className="relative w-full bg-[#111] py-32 px-6 md:px-12 border-t border-[#4E5661]/10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-24 flex shrink-0 items-end gap-6 text-left">
            ...
            <div>
              <h2 className="font-serif text-[#F5F2EA] text-4xl md:text-6xl mb-2">
                Knockout Battleground
              </h2>
              <p className="font-sans text-[#D4AF37] tracking-[0.2em] uppercase text-xs">
                Tactical Confrontation Maps
              </p>
            </div>
          </div>
            ...
            {details.knockoutDrama?.map((match, idx) => (
              ...
              >
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center gap-2 text-xs text-[#69707A]">
                      ...
                      <span className="font-sans uppercase tracking-widest text-[9px] font-semibold">
                        Battlefield Report
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center mb-8 bg-black/60 p-5 border border-[#4E5661]/15 rounded-sm">
                    <div className="text-left">
                      <span className="block font-sans text-[9px] text-[#69707A] uppercase tracking-wider mb-1">
                        Forces A
                      </span>
                    ...
                    <span className="font-serif text-2xl lg:text-3xl text-[#D4AF37] font-extrabold px-4">
                      {match.score}
                    </span>
                ...
                <div className="mt-6 pt-6 border-t border-[#4E5661]/15">
                  <p className="font-sans text-[10px] text-[#69707A] uppercase tracking-widest mb-2 font-semibold">
                    Moments of Conquest
                  </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {details.heroes?.map((hero, idx) => (
              ...
              >
                {/* Hero Image */}
                <div className="w-full md:w-5/12 h-64 md:h-full relative overflow-hidden shrink-0">
                  <VerifiedImage
                    src={hero.image}
                    alt={`${hero.name} (Tournament Protagonist)`}
                    className="w-full h-full"
                    aspectRatio="auto"
                    tournament={tournament.host}
                    date={`${tournament.year}`}
                    context={hero.legacyMoment}
                    eraStyle={
                      tournament.year <= 1954
                        ? "antique"
                ...
                <div className="w-full md:w-7/12 p-8 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="font-sans text-[10px] text-[#69707A] uppercase tracking-widest font-semibold">
                        {hero.role}
                      </span>
                    </div>
                    <h3 className="font-serif text-white text-3xl font-bold mb-4 tracking-tight">
                      {hero.name}
                    </h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6 pt-4 border-t border-white/5">
                      {hero.stats.map((stat, sIdx) => (
                        <div key={sIdx} className="text-left">
                          <span className="block font-sans text-[9px] text-[#69707A] uppercase tracking-wider mb-1 truncate">
                            {stat.label}
                          </span>
                          <span className="font-serif text-xl sm:text-2xl font-bold text-[#D4AF37]/90">
                            {stat.value}
                          </span>
                        </div>
                      ))}
                  ...
                  <div className="pt-4 border-t border-white/5 font-serif text-xs text-[#69707A] leading-relaxed">
                    <span className="block font-sans text-[9px] text-[#D4AF37] uppercase tracking-widest mb-1.5 font-semibold">
                      Legendary Exhibit Moment
                    </span>
                    <p className="italic">"{hero.legacyMoment}"</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {details.definingMoments.map((moment, idx) => (
                <motion.div
                  key={idx}
                  className="group relative overflow-hidden bg-[#090909] border border-white/5 rounded-sm shadow-xl"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.8 }}
            ...
            {details.stadiums?.map((stadium, idx) => (
              ...
              >
                <div className="aspect-[16/10] relative">
                  <VerifiedImage
                    src={stadium.image}
                    alt={`${stadium.name} Architectural Exhibit`}
                    className="w-full h-full"
                    aspectRatio="auto"
                    tournament={tournament.host}
                    date={`${tournament.year}`}
                    context={stadium.notableMatch}
                    eraStyle={
                      tournament.year <= 1954
                        ? "antique"
                        : tournament.year <= 1986
                ...
                <div className="p-6 md:p-8">
                  <div className="flex justify-between items-baseline mb-4">
                    <h3 className="font-serif text-white text-2xl font-bold tracking-tight">
                      {stadium.name}
                    </h3>
                    <span className="font-sans text-xs text-[#D4AF37] font-semibold tracking-wider">
                  ...
                  <div className="pt-4 border-t border-white/5 flex items-center gap-4">
                    ...
                    <p className="font-serif text-xs text-[#DDD7C8]/90 italic">
                      {stadium.notableMatch}
                    </p>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {details.stats?.map((stat, idx) => (
              ...
              >
                <div>
                  <span className="block font-sans text-[10px] text-[#69707A] uppercase tracking-widest mb-4 font-semibold">
                    {stat.label}
                  </span>
                  <p className="font-serif text-5xl font-extrabold text-[#D4AF37] mb-4 tracking-tighter">
                    {stat.value}
                  </p>
                  <p className="font-serif text-sm text-[#DDD7C8]/80 leading-relaxed italic">
                    {stat.subText}
                  </p>
                </div>
                ...
                <div className="mt-6 border-t border-white/5 pt-4">
                  ...
                  >
                    ...
                    {expandedStats[idx] ? (
                      ...
                      <ChevronDown size={14} className="text-[#69707A]" />
                    )}
                  </button>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-sans text-[10px] text-[#D4AF37] uppercase tracking-widest font-semibold">
                Historical Tactical Trend Evolution
              </h3>
            </div>
            <p className="font-serif text-lg md:text-xl leading-relaxed text-[#DDD7C8] italic max-w-4xl opacity-95">
              "
              {details.tacticalTrend ||
                "The tournament served to catalog and accelerate tactical adjustments, defining professional lineups for the subsequent decade."}
              "
            </p>
          </motion.div>
        </div>
      ...
      <section className="relative w-full bg-[#090909] py-48 px-6 md:px-12 flex flex-col justify-center items-center text-center border-t border-[#4E5661]/15">
        ...
        <div className="w-full max-w-4xl mt-8 mb-24 border-t border-[#4E5661]/20 pt-16 text-left relative z-10 mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {(() => {
              ...
              > = {
                1930: {
                  id: "pele",
                  name: "Pelé",
                  tag: "Chamber Standard of Immortality",
                },
                1954: {
                  id: "pele",
                  name: "Pelé",
                ...
                1958: {
                  id: "pele",
                  name: "Pelé",
                  tag: "The Golden Boy’s Emergence",
                },
                1962: {
                  id: "pele",
                  name: "Pelé",
                  tag: "Double-Crown Dynastic Champion",
                },
                1970: {
                  id: "pele",
                  name: "Pelé",
                  tag: "The Zenith of Jôgo Bonito",
                },
                1982: {
                  id: "rossi",
                  name: "Paolo Rossi",
                  tag: "The Golden Boy who humbled Brazil",
                },
                1986: {
                  id: "maradona",
                  name: "Diego Maradona",
                  tag: "Cosmic Barrilete Cósmico",
                },
                1998: {
                  id: "zidane",
                  name: "Zinedine Zidane",
                  tag: "Double Header of St. Denis",
                },
                2002: {
                  id: "ronaldo",
                  name: "Ronaldo Nazário",
                  tag: "Double Stroke of Redemption",
                },
                2006: {
                  id: "zidane",
                  name: "Zinedine Zidane",
                  tag: "The Majestic Tragedy Final",
                },
                2014: {
                  id: "messi",
                  name: "Lionel Messi",
                  tag: "The Near Miss in Rio",
                },
                2022: {
                  id: "messi",
                  name: "Lionel Messi",
                  tag: "The Path to Soccer Divinity",
                },
              };
              const relLegend = legendMap[tournament.year] || {
                id: "pele",
                name: "Pelé",
                tag: "The Standard of Immortality",
              };
              return (
                <div
                  onClick={() => {
                ...
                >
                  <span className="font-mono text-[8px] text-[#AFA58D] font-black uppercase block mb-1 font-bold">
                    CHAMBER II • IMMORTAL TITAN
                  </span>
                  <h4 className="font-serif text-lg text-[#F5F2EA] group-hover:text-[#D4AF37] font-black uppercase transition-colors">
                    {relLegend.name}
                  </h4>
                  <p className="font-sans text-xs text-[#69707A] font-light mt-1.5 leading-relaxed">
                    {relLegend.tag}
                  </p>
                </div>
              );
            ...
            {(() => {
              ...
              const relStadium = stadiumMap[tournament.year] || {
                id: "azteca",
                name: "Estadio Azteca",
                country: "Mexico",
              };
              return (
                ...
                >
                  <span className="font-mono text-[8px] text-[#AFA58D] font-black uppercase block mb-1 font-bold">
                    CHAMBER VI • ARCHITECTURAL COLISEUM
                  </span>
                  <h4 className="font-serif text-lg text-[#F5F2EA] group-hover:text-[#D4AF37] font-black uppercase transition-colors">
                    {relStadium.name}
                  </h4>
                  <p className="font-sans text-xs text-[#69707A] font-light mt-1.5 leading-relaxed">
                    Historic coliseum in {relStadium.country}.
                  </p>
                </div>
              );
            })()}
            ...
            {(() => {
              const nationMap: Record<
                number,
                { id: string; name: string; dynasty: string }
              > = {
                1930: {
                  id: "uruguay",
                  name: "Uruguay",
                  dynasty: "Inaugural Golden Pioneers",
                },
                1950: {
                  id: "uruguay",
                  name: "Uruguay",
                  dynasty: "Slayer of Maracanazo",
                },
                1958: {
                  id: "brazil",
                  name: "Brazil",
                  dynasty: "Samba Invention Era",
                },
                1962: {
                  id: "brazil",
                  name: "Brazil",
                  dynasty: "Back-to-Back Sovereigns",
                },
                1970: {
                  id: "brazil",
                  name: "Brazil",
                  dynasty: "The Greatest XI Dynasty",
                },
                1982: {
                  id: "italy",
                  name: "Italy",
                  dynasty: "Rossi’s Counter-Attack Symphony",
                },
                1986: {
                  id: "argentina",
                  name: "Argentina",
                  dynasty: "Maradona’s Solo Supremacy",
                },
                1998: {
                  id: "france",
                  name: "France",
                  dynasty: "The Rainbow Revolution",
                },
                2002: {
                  id: "brazil",
                  name: "Brazil",
                  dynasty: "The Pentacampeão Masterpiece",
                },
                2014: {
                  id: "germany",
                  name: "Germany",
                  dynasty: "The Engineered 7-1 Blitzkrieg",
                },
                2022: {
                  id: "argentina",
                  name: "Argentina",
                  dynasty: "Messi’s Crown of Divinity",
                },
              };
              const relNation = nationMap[tournament.year] || {
                id: "brazil",
                name: "Brazil",
                dynasty: "Samba Dynastic Giants",
              };
              return (
                <div
                  onClick={() => {
        ...
        <p className="font-sans text-[#69707A] tracking-[0.3em] uppercase text-[10px] mb-8 font-semibold">
          Chapter X • Eternal Epilogue
        </p>
        ...
        <div className="w-full mt-24 border-t border-[#D4AF37]/15 pt-16 text-left">
          <ContinueExploringSystem
            ...
            onExploreMatches={(mId) => {
              onClose();
              if (onExploreClassicMatch) onExploreClassicMatch(mId);
            }}
            onExploreNations={(nId) => {
              onClose();
              if (onExploreNation) onExploreNation(nId);
            }}
            onExploreLegends={(lId) => {
              onClose();
              if (onExploreLegend) onExploreLegend(lId);
            }}
            onExploreStadiums={(sId) => {
              onClose();
              if (onExploreStadium) onExploreStadium(sId);
            }}
            onExploreTournament={(year) => {
              if (year !== tournament.year) {
                onClose();
                if (onExploreTournament) onExploreTournament(year);
              }
            }}
          />
        </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-4 mb-1">
                ...
                <span className="font-sans text-[9px] uppercase tracking-widest text-[#69707A] font-semibold italic truncate">
